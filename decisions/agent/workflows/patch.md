...
are redesigning anything. Escalate to debug.md the moment you have read ~5 files and still cannot
...
4. **Verify**, run the narrowest test covering the change. If this was a bug, add the regression
   test that fails without your fix. Then the project test command if it is reasonably fast.
