...
Detect each trait with RF-DETR, an object detector, segmenter, and
keypoint model from Roboflow. Run it over RFD 0064's dataset images,
and over the layer outputs RFD 0044's composite already produces.
...
this RFD runs beside. RFD 0021 gives the `HRR` library. RFD 0028
gives the license gate this RFD's model choice must clear.
