...
3. **Generate certificates:**
   ```bash
   mkcert localhost 127.0.0.1 ::1 10.0.0.32
   ```
...
6. **Access via HTTPS:**
   ...
   - `https://10.0.0.32:3000` (for Galaxy XR device)
...
2. Find your computer's IP address (e.g., `10.0.0.32`)
3. Add the IP to the certificate (see mkcert step 3 above)
4. Access via `https://10.0.0.32:3000` on the Galaxy XR device
