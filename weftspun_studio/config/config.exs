...
# Nx falls back to its binary backend when EXLA is absent. Naming
# EXLA.Backend unconditionally would crash the first tensor op on a
# host that has no EXLA, such as Windows.
