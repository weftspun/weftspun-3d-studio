...
user asks. (Fixing a wrong doc line you stumble on mid-task is NOT this workflow, that is prime
...
6. **Report** (read-only): uncommitted drift, failing tests, anything smelling of rot you did not fix.
